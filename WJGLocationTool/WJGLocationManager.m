...
@interface WJGLocationManager()<CLLocationManagerDelegate,UIAlertViewDelegate>
@property (nonatomic, strong) CLLocationManager *CLLM;
@property (nonatomic, strong) WJGCityModel *currentLocatedCityModel;
@property (nonatomic, strong) CLPlacemark *currentPlaceMark;
@property (nonatomic, assign,getter=hadUpdate) BOOL Updated;
@end

@implementation WJGLocationManager
static WJGLocationManager * locationManager = nil;
    ...
    [geocoder reverseGeocodeLocation:location completionHandler:^(NSArray *array, NSError *error){
        if(!self.hadUpdate) {
            if (array.count > 0){
                ...
                //得到当前定位到的城市
                self.currentLocatedCityModel = [WJGCityModel cityModelWithCity:city longitude:coordinate.longitude latitude:coordinate.latitude];
